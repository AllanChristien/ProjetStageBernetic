...
/////////////////////////////////////////////////////////////////
	$requete = mysqli_query("SELECT id FROM documents");
...
<table width="600" border="16" align="center" cellpadding="12" cellspacing="6" class="soustitrenoir">
      <tbody>
        <tr>
          ...
          télécharger un fichier<br>
          pour finaliser l'opération.</td>
        </tr>
      </tbody>
</table>
...
mysqli_query("UPDATE documents SET posteur='$NomPosteurM', datecreation='$DateM', dateperemption='$DateValidM', version='$VersionM', type='$TypeM', servicedoc='$ServiceM', titre='$TitreM', destinataires='$DestinatairesM', etatdoc='$etat' WHERE id='$IDM'") or die(mysqli_error());
?><script type="text/JavaScript">
<!--
function redirection(page)
  {window.location=page;}
setTimeout('redirection("pfok.php")',0);
//--> 
</script>  
<?php          
...
if(!in_array($extension, $extensions)) //Si l'extension n'est pas dans le tableau
{
	 ...
	 '<table width="500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="red"><tbody><tr>
	  ...
	  Vous ne pouvez pas télécharger ce type de fichier</td></tr></tbody></table>';
...
if($taille>$taille_maxi)
{
	...
	'<table width="500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="red"><tbody><tr>
      <td width="500" height="40" align="center" valign="middle" class="soustitre">
	  Votre fichier dépasse le poids autorisés...</td></tr></tbody></table>';
}
...
$Now = date("dmy");    
    $fichier = $IDM."_".$Now."_".$fichier ;
     if(move_uploaded_file($_FILES['avatar']['tmp_name'], $dossier . $fichier)) //Si la fonction renvoie TRUE, c'est que ça a fonctionné...
     {
      ...
      <td width="500" height="40" align="center" valign="middle" class="soustitre">
	  Votre fichier a été t&eacutel&eacutecharg&eacute</td></tr></tbody></table>'; 
			  
			  'Upload effectué avec succès !';
	 
		 		// Alors on modifie l'actu correspondante 
mysqli_query("UPDATE documents SET posteur='$NomPosteurM', datecreation='$DateM', dateperemption='$DateValidM', nomfichier='$fichier', version='$VersionM', type='$TypeM', servicedoc='$ServiceM', titre='$TitreM', destinataires='$DestinatairesM', etatdoc='$etat' WHERE id='$IDM'") or die(mysqli_error());
...
$modif_Etat = $donall['etatdoc'];	
    ...
    ?>
            ...
            <form action="../admin/pfok.php" method="post" enctype="multipart/form-data" name="formulaire" id="formulaire2">
              <table width="90%" border="0" align="center" cellpadding="2" cellspacing="0" bgcolor="#434343" class="fondtransp1">
                <tr>
                  <td height="40" colspan="4" align="center" bgcolor="#D97900" style="color: #FFFFFF"><span class="soustitre">Modification du document  &#8470;<?php echo $modifT ; ?></span></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <?php if (empty($modif_NomFichier)) { ?>
                    <td height="40" colspan="4" align="center" bgcolor="red" class="TextPlanBlanc" style="color: #FFFFFF"> <?php echo "Aucun fichier tél&eacutecharg&eacute pour le moment" ;?></td>
                    <?php } else { ?>
                ...
                <tr>
                  <td height="40" colspan="4" bgcolor="#2B2B2B" style="color: #FFFFFF"><div align="center">
                    <span class="TextPlanBlanc">Destinataire : 
	      ...
	      <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="fondtransp1">
	        <tr>
	          <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
	            <tr>
	              <td height="30" colspan="6" align="center" valign="middle" bgcolor="#286800"><span class="soustitre"> en ligne</span></td>
	              </tr>
	            <tr>
	             <td width="78" height="30" align="center" valign="middle" bgcolor="#BBB8B8"><span class="TextPlanNoir1">Numéro du document</span><br /></td>
                    <td width="171" height="30"  align="center" valign="middle" bgcolor="#BBB8B8" class="TextPlanNoir1">Créé par</td>
...
?>
	            ...
	            <table width="100%" border="0" bordercolor="#FFFFFF" cellspacing="3" cellpadding="0">
	              <tr>
	                ...
	                <td width="70" align="center" valign="middle" class="TextPlanBlanc"><input type="button" value="Modifier" onclick="window.location.href='<?php echo 'pfok.php?modifT='.$ID.'' ; ?>';"></td>
	                ...
	                <td width="37" align="center" valign="middle" bgcolor="#8C8C8C"><a href="<?php echo 'pfok.php?supprimer=' . $ID . '&amp;Fichier='.$NomFichier.''; ?>" onclick="return confirm_del()"><img src="supproff.png" alt="supprimer" name="suprimer" width="25" height="25" border="0" id="suprimer2" /></a></td>
	                </tr>
