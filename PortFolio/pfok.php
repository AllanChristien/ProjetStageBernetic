...
mysqli_query("UPDATE documents SET posteur='$NomPosteurM', dateproduction='$DateM', dateperemption='$DateValidM', version='$VersionM', type='$TypeM', servicedoc='$ServiceM', titre='$TitreM', destinataires='$DestinatairesM', etatdoc='$etat' WHERE id='$IDM'") or die(mysqli_error());
?><script type="text/JavaScript">
<!--
...
mysqli_query("UPDATE documents SET posteur='$NomPosteurM', dateproduction='$DateM', dateperemption='$DateValidM', nomfichier='$fichier', version='$VersionM', type='$TypeM', servicedoc='$ServiceM', titre='$TitreM', destinataires='$DestinatairesM', etatdoc='$etat' WHERE id='$IDM'") or die(mysqli_error());
